...
$OutDir = Join-Path $Root "screen_tensor_anova_boundary_w0005_protected_hard_s8k_from_anchor_20260702"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --tensor-anova-boundary-weight 0.0005 `
    --tensor-anova-boundary-focus hard `
    --tensor-anova-boundary-margin 0.04 `
    --tensor-anova-boundary-uncertainty-margin 0.25 `
    --tensor-anova-boundary-gate-temperature 10.0 `
    --tensor-anova-boundary-friction-weight 0.6 `
    --tensor-anova-boundary-material-weight 0.4 `
    --tensor-anova-boundary-roughness-weight 1.0 `
    --tensor-anova-boundary-obstruction-weight 0.8 `
    --online-teacher-checkpoint $ResumeFrom `
    --online-teacher-weight 0.02 `
