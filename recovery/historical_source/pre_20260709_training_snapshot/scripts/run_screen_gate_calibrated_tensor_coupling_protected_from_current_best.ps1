...
$OutDir = Join-Path $Root "screen_gate_calibrated_tensor_coupling_protected_s4k_cap120_from_current_best_20260703"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --hard-pair-sampling `
    --hard-pair-sampling-fraction 0.65 `
    ...
    --teacher-error-replay-weight 0.08 `
