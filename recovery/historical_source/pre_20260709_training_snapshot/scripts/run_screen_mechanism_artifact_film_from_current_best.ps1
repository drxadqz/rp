...
$OutDir = Join-Path $Root "screen_mechanism_artifact_film_s4k_cap120_from_current_best_20260703"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --mechanism-conditioned-artifact-gate-scale 0.10 `
    --mechanism-conditioned-artifact-gate-temperature 0.75 `
    --use-texture-film `
    --texture-film-scale 0.05 `
    --train-only-module-prefix mechanism_conditioned_artifact_gate `
