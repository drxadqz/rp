...
$OutDir = Join-Path $Root "screen_mechanism_cft_branchcal_s4k_cap120_from_current_best_20260703"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --train-only-module-prefix dry_concrete_roughness_vor_residual `
    --train-only-module-prefix norm `
    --controlled-factor-tournament-sampling `
    --controlled-factor-tournament-sampling-fraction 0.70 `
    --mechanism-controlled-factor-tournament-weight 0.004 `
    --mechanism-controlled-factor-tournament-temperature 0.15 `
    --mechanism-controlled-factor-tournament-margin 0.08 `
    --mechanism-controlled-factor-tournament-neg-weight 1.0 `
    --mechanism-controlled-factor-tournament-focus core `
    --mechanism-controlled-factor-tournament-friction-weight 0.8 `
    --mechanism-controlled-factor-tournament-material-weight 0.5 `
    --mechanism-controlled-factor-tournament-unevenness-weight 1.4 `
    --online-teacher-checkpoint $Anchor `
    --online-teacher-weight 0.20 `
