...
$OutDir = Join-Path $Root "screen_tri_chart_evidence_film_s4k_cap120_from_current_best_20260703"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --tri-chart-evidence-film-hidden-dim 256 `
    --tri-chart-evidence-film-scale 0.035 `
    --tri-chart-evidence-film-gate-temperature 18.0 `
    --train-only-module-prefix tri_chart_evidence_film `
    ...
    --directed-confusion-weight 0.0005 `
    ...
    --checkpoint-selection-hard-slice-classes water_concrete_slight,water_concrete_severe,wet_concrete_slight,wet_concrete_severe,wet_asphalt_severe,water_asphalt_severe,water_gravel `
