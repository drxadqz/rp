...
$OutDir = Join-Path $Root "screen_fcpe_append_protected_s8k_e2_from_anchor_20260702"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --factor-coupled-physics-token-dim 64 `
    --factor-coupled-physics-token-inner-dim 16 `
    ...
    --train-only-module-prefix factor_coupled_physics_token_branch `
