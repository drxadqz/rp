...
$OutDir = Join-Path $Root "screen_competitive_orthogonal_tensor_coupling_s8k_e2_from_anchor_20260702"

& $Python scripts\run_rscd_surface_classification.py `
    --output-dir $OutDir `
    --backbone convnext_tiny_competitive_orthogonal_tensor_coupling_stem `
    --embedding-dim 768 `
    --image-size 192 `
    ...
    --train-only-module-prefix backbone.competitive_orthogonal_tensor_coupling_banks `
