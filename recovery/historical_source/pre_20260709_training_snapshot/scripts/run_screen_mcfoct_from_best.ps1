...
$FallbackBest = Join-Path $Root "screen_local_physics_hflip_relation_cond_w0005_core_s8k_from_hflip\best.pt"
$ResumeFrom = $FallbackBest

$OutDir = Join-Path $Root "screen_mcfoct_trainonly_s12k_e2_from_best_20260701"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --train-only-module-prefix mechanism_charted_full_order_coupling_tensor_field `
