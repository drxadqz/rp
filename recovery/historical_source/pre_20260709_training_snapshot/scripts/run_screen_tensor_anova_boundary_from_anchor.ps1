...
$OutDir = Join-Path $Root "screen_tensor_anova_boundary_w003_hard_s8k_from_anchor_20260702"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --tensor-anova-boundary-weight 0.003 `
    --tensor-anova-boundary-focus hard `
    --tensor-anova-boundary-margin 0.06 `
    --tensor-anova-boundary-uncertainty-margin 0.35 `
    --tensor-anova-boundary-gate-temperature 12.0 `
    --tensor-anova-boundary-friction-weight 0.9 `
    --tensor-anova-boundary-material-weight 0.6 `
    --tensor-anova-boundary-roughness-weight 1.4 `
    --tensor-anova-boundary-obstruction-weight 1.5 `
