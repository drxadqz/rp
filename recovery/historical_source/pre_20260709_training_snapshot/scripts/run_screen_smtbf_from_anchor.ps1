...
$OutDir = Join-Path $Root "screen_smtbf_s8k_e2_from_anchor_20260702"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --selective-mechanism-tensor-boundary-scale 0.08 `
    --selective-mechanism-tensor-boundary-gate-threshold 0.10 `
    --selective-mechanism-tensor-boundary-gate-temperature 10.0 `
    --selective-mechanism-tensor-boundary-mechanism-gate-threshold 0.08 `
    --selective-mechanism-tensor-boundary-mechanism-gate-temperature 12.0 `
