...
$Config = "configs\c3_farnet\c3_farnet_screen_control_simple_cnn_warmup_20260710.yaml"
$OutDir = "E:\perception_outputs\rscd_surface_classification\c3_farnet_screen_control_simple_cnn_warmup_20260710"
