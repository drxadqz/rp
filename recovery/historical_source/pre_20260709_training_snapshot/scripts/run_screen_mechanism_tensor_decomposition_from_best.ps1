...
$OutDir = Join-Path $Root "screen_mechanism_tensor_decomposition_stem_trainonly_s8k_e2_from_best_20260702"

& $Python scripts\run_rscd_surface_classification.py `
    --output-dir $OutDir `
    --backbone convnext_tiny_mechanism_tensor_decomposition_stem `
    --embedding-dim 768 `
    --image-size 192 `
    ...
    --train-only-module-prefix backbone.mechanism_tensor_decomposition_banks `
