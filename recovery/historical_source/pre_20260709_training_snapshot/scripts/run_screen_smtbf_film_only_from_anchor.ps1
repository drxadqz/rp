...
$OutDir = Join-Path $Root "screen_smtbf_film_only_s8k_e2_from_anchor_20260702"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --selective-mechanism-tensor-boundary-enabled-mechanisms asphalt_wet_sheen,concrete_thin_film `
    --selective-mechanism-tensor-boundary-hidden-dim 64 `
    --selective-mechanism-tensor-boundary-pair-dim 12 `
    --selective-mechanism-tensor-boundary-relation-dim 6 `
    --selective-mechanism-tensor-boundary-mechanism-dim 8 `
    --selective-mechanism-tensor-boundary-scale 0.06 `
    --selective-mechanism-tensor-boundary-gate-threshold 0.12 `
    --selective-mechanism-tensor-boundary-gate-temperature 10.0 `
    --selective-mechanism-tensor-boundary-mechanism-gate-threshold 0.10 `
    --selective-mechanism-tensor-boundary-mechanism-gate-temperature 14.0 `
    --selective-mechanism-tensor-boundary-protected-negative-limit 0.0 `
    ...
    --online-teacher-checkpoint $ResumeFrom `
    --online-teacher-weight 0.05 `
    --online-teacher-temperature 2.0 `
    --online-teacher-beta 4.0 `
    --online-teacher-min-confidence 0.0 `
    --teacher-error-replay-weight 0.05 `
    --teacher-error-replay-focus concrete_wetwater_rough_v1 `
    --teacher-error-replay-beta 2.0 `
    ...
    --train-only-module-prefix selective_mechanism_tensor_boundary_field
