...
$OutDir = Join-Path $Root "screen_observer_hinf_artifact_guard_v2_s4k_cap120_from_current_best_20260703"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --online-teacher-weight 0.12 `
    --online-teacher-temperature 2.0 `
    --online-teacher-beta 4.0 `
    --online-teacher-min-confidence 0.65 `
    --observer-hinf-weight 0.00055 `
    --observer-hinf-mode mixed `
    --observer-hinf-scope core_paved `
    --observer-hinf-strength 0.75 `
    --observer-hinf-rho 0.18 `
    --observer-hinf-max-lines 4 `
    --observer-hinf-block-ratio 0.12 `
    --observer-hinf-temperature 2.0 `
    --observer-hinf-confidence-threshold 0.55 `
    --observer-hinf-feature-weight 0.10 `
    --observer-hinf-physics-feature-weight 0.60 `
    --observer-hinf-local-physics-feature-weight 0.60 `
    --observer-hinf-low-level-feature-weight 0.20 `
    --observer-hinf-class-consistency-weight 0.04 `
    --observer-hinf-factor-consistency-weight 0.50 `
    --observer-hinf-disturbed-ce-weight 0.05 `
    --observer-hinf-barrier-weight 0.0010 `
    --observer-hinf-barrier-scope wet_water_paved `
    --observer-hinf-barrier-margin-drop 0.03 `
    --relation-conditional-weight 0.0020 `
