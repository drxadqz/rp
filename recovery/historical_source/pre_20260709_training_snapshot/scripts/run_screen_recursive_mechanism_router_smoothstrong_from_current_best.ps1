...
$OutDir = Join-Path $Root "screen_recursive_mechanism_router_smoothstrong_s4k_cap120_from_current_best_20260703"

& $Python scripts\run_rscd_surface_classification.py `
    --output-dir $OutDir `
    --backbone convnext_tiny_recursive_mechanism_router_smoothstrong `
    --embedding-dim 768 `
    --image-size 192 `
