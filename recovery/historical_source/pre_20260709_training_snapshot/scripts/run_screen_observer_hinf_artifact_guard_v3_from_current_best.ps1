...
$OutDir = Join-Path $Root "screen_observer_hinf_artifact_guard_v3_s4k_cap120_from_current_best_20260703"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --observer-hinf-low-level-feature-weight 0.15 `
    --observer-hinf-class-consistency-weight 0.03 `
    --observer-hinf-factor-consistency-weight 0.60 `
    --observer-hinf-disturbed-ce-weight 0.03 `
    --observer-hinf-barrier-weight 0.0020 `
    --observer-hinf-barrier-scope wet_water_paved `
    --observer-hinf-barrier-margin-drop 0.02 `
    --relation-conditional-weight 0.0015 `
