...
$OutDir = Join-Path $Root "screen_material_smooth_fidelity_adapter_classifier_protected_s4k_e1_20260703"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --online-teacher-weight 0.035 `
    --online-teacher-temperature 2.0 `
    --online-teacher-beta 4.0 `
    --online-teacher-min-confidence 0.72 `
