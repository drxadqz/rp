...
OUT = Path("reports/paper_protocol_summary/rscd_residual_adapter_promotion_decision")
...
def main() -> None:
    ...
    result = {
        ...
        "promotion_rule": (
            "Promote residual-adapter candidate only if it improves fast Macro-F1 by more "
...
def to_markdown(result: dict) -> str:
    lines = [
        "# RSCD Residual-Adapter Promotion Decision",
        "",
