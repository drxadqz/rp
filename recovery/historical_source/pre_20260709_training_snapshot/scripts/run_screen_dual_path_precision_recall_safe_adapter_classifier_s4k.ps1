...
$OutDir = Join-Path $Root "screen_dual_path_precision_recall_safe_adapter_classifier_s4k_e1_20260703"

& $Python scripts\run_rscd_surface_classification.py `
    --output-dir $OutDir `
    --backbone convnext_tiny_dual_path_precision_recall_stem_safe `
    --embedding-dim 768 `
    --image-size 192 `
    ...
    --train-only-module-prefix backbone.dual_path_adapters `
