...
$OutDir = Join-Path $Root "screen_visibility_cellular_tensor_coupling_stem_trainonly_s8k_e2_from_best_20260702"

& $Python scripts\run_rscd_surface_classification.py `
    --output-dir $OutDir `
    --backbone convnext_tiny_visibility_cellular_tensor_coupling_stem `
    --embedding-dim 768 `
    --image-size 192 `
    ...
    --train-only-module-prefix backbone.visibility_cellular_tensor_coupling_banks `
