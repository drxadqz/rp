...
$OutDir = Join-Path $Root "screen_smooth_evidence_texture_gate_s4k_cap120_from_current_best_20260703"
...
& $Python scripts\run_rscd_surface_classification.py `
    ...
    --smooth-evidence-texture-gate-scale 0.10 `
    --smooth-evidence-texture-gate-temperature 18.0 `
    --smooth-evidence-texture-gate-rough-suppression 0.80 `
    --use-texture-film `
    --texture-film-scale 0.045 `
    --train-only-module-prefix smooth_evidence_texture_gate `
    --train-only-module-prefix texture_film `
