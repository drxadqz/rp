...
$OutDir = Join-Path $Root "screen_protected_smooth_boundary_early_strong_adapteronly_s4k_e1_20260703"

& $Python scripts\run_rscd_surface_classification.py `
    --output-dir $OutDir `
    --backbone convnext_tiny_protected_smooth_boundary_early_strong `
    --embedding-dim 768 `
    --image-size 192 `
