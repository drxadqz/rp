...
$Log = Join-Path $LogDir "fast_texture_film_after_queue.log"
...
Write-QueueLog "started texture-FiLM RSCD fast queue"
Wait-ProcessIds -Ids $WaitPids -Name "existing RSCD/direct/residual queue"
...
Write-QueueLog "texture-FiLM candidates complete"
